...
QT_MOC_LITERAL(1, 12, 17), // "stopMissionSignal"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 12), // "MissionItem*"
QT_MOC_LITERAL(4, 44, 15) // "missionComplete"

    },
    "MissionItem\0stopMissionSignal\0\0"
    "MissionItem*\0missionComplete"
};
...
void MissionItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->stopMissionSignal((*reinterpret_cast< MissionItem*(*)>(_a[1]))); break;
        case 1: _t->missionComplete(); break;
        default: ;
        }
        ...
        {
            typedef void (MissionItem::*_t)(MissionItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MissionItem::stopMissionSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MissionItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MissionItem.data,
      qt_meta_data_MissionItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MissionItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MissionItem.stringdata0))
        return static_cast<void*>(const_cast< MissionItem*>(this));
...
// SIGNAL 0
void MissionItem::stopMissionSignal(MissionItem * _t1)
{

...
* @note 增加svc配置项
*/
ULONG_32 STDCALL IMOS_ConfigECVideoStreamV2
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLoginIDInfo,
    IN  DEV_CHANNEL_INDEX_S             *pstChannelIndex,
...
* @note 新增svc配置
*/
ULONG_32 STDCALL IMOS_QueryECVideoStreamV2
(
    IN    USER_LOGIN_ID_INFO_S        *pstUserLoginIDInfo,
    IN    DEV_CHANNEL_INDEX_S         *pstChannelIndex,
    INOUT ULONG_32                       *pulStreamNum,
...
* @note 无
*/
ULONG_32 STDCALL IMOS_ModifyCDS
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLoginIDInfo,
    IN  CDS_INFO_S                  *pstSDKCDSInfo
);
...
*/
ULONG_32 STDCALL IMOS_QueryCDSList
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLoginIDInfo,
    IN  CHAR                        szOrgCode[IMOS_DOMAIN_CODE_LEN],
    IN  COMMON_QUERY_CONDITION_S    *pstQueryCondition,
...
*/
ULONG_32 STDCALL IMOS_QueryAllStorageDevList
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLoginIDInfo,
    IN  CHAR                        szOrgCode[IMOS_DOMAIN_CODE_LEN],
    IN  COMMON_QUERY_CONDITION_S    *pstQueryCondition,
...
* @note
*/
ULONG_32 STDCALL IMOS_QueryCDSInfo
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLoginIDInfo,
    IN  CHAR                        szCDSCode[IMOS_DEVICE_CODE_LEN],
...
* @note
*/
ULONG_32 STDCALL IMOS_QueryCDSInfoV2
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLoginIDInfo,

...
*/
ULONG_32 STDCALL IMOS_QueryPictureInfo
(
...
* - 1. 该接口仅支持ECR设备
*/
ULONG_32 STDCALL IMOS_ProcessShareOutputSrcForECR
(
    IN  USER_LOGIN_ID_INFO_S   *pstUserLogIDInfo,
...
* - 1. 该接口仅支持VM平台
*/
ULONG_32 STDCALL IMOS_QuerySalvoV2
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
...
* - 1. 该接口仅支持VM平台
*/
ULONG_32 STDCALL IMOS_QueryGroupSwitchResListUnderUA
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLoginIDInfo,
    IN  CHAR                        szUACode[IMOS_RES_CODE_LEN],
    IN  COMMON_QUERY_CONDITION_S    *pstQueryCondition,
...
* 2.变长元素个数和变长元素内存长度由调用者保证，变长元素个数不可大于变长元素实际内存长度
*/
ULONG_32 STDCALL IMOS_BindCameraToVideoInChannelV3
(
    IN  USER_LOGIN_ID_INFO_S                    *pstUserLoginIDInfo,
...
* @attention
*/
ULONG_32 STDCALL IMOS_ModifyBackupPlanDelayInfo
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLoginIDInfo,
...
* @attention
*/
ULONG_32 STDCALL IMOS_QueryBackupPlanDelayInfo
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLoginIDInfo,
    IN  ULONG_32                                 ulNumber,
...
* - 1. 该接口仅支持VM平台
*/
ULONG_32 STDCALL IMOS_GetMapColors
(
    IN  USER_LOGIN_ID_INFO_S         *pstUserLogIDInfo,
    IN  CHAR                         szGISMapCode[IMOS_CODE_LEN],
...
* - 1. 该接口仅支持VM平台
*/
ULONG_32 STDCALL IMOS_SetMapColors
(
    IN  USER_LOGIN_ID_INFO_S         *pstUserLogIDInfo,
    IN  CHAR                         szGISMapCode[IMOS_CODE_LEN],
...
* 2.变长元素个数和变长元素内存长度由调用者保证，变长元素个数不可大于变长元素实际内存长度
*/
ULONG_32 STDCALL IMOS_BindCameraToVideoInChannelV4
(
    IN  USER_LOGIN_ID_INFO_S                    *pstUserLoginIDInfo,
...
* @note 无
*/
ULONG_32 STDCALL IMOS_QuerySwitchListV3
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLoginIDInfo,
    IN  CHAR                        szDevCode[IMOS_DEVICE_CODE_LEN],
    IN  ULONG_32                       ulDevType,
...
* @note
*/
ULONG_32 STDCALL IMOS_AddRetryBakTask
(
    IN  USER_LOGIN_ID_INFO_S          *pstUserLoginIDInfo,
...
* @note
*/
ULONG_32 STDCALL IMOS_DelRetryBakTask
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLoginIDInfo,
...
* @return ERR_COMMON_SUCCEED    表示成功，失败返回请见错误码
*/
ULONG_32 STDCALL IMOS_QueryScreenMonRelation
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLoginIDInfo,
    IN  CHAR                        szMonitorCode[IMOS_RES_CODE_LEN],
...
* @note pstSrcUAList和pstDstUAList的内存需要由调用者申请
*/
ULONG_32 STDCALL IMOS_QueryTCPStrate
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
...
* @note 无
*/
ULONG_32 STDCALL IMOS_ModifyTCPStrate
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
...
* @note 无
*/
ULONG_32 STDCALL IMOS_QueryEcInfoV2
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLoginIDInfo,
    IN  CHAR                            szEcCode[IMOS_DEVICE_CODE_LEN],
